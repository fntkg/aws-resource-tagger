...
def tag(
        ...
        tags_file: str = typer.Argument(
            ..., help="Path to the file containing a list of tags to apply, provided in JSON format. "
    ...
    Args:
        ...
        tags_file (str): Path to the file containing tags to apply, provided in JSON format.
